...
#define STACK_USE_GENERIC_TCP_CLIENT_EXAMPLE	// HTTP Client example in GenericTCPClient.c - SEPT/27TH
#define STACK_USE_LED_TCP_SERVER_EXAMPLE	// ToUpper server example in GenericTCPServer.c -SEPT/27TH
#define STACK_USE_TCP_TO_UPPER_SERVER           //SEPT/27TH
#define STACK_USE_GENERIC_TCP_SERVER_EXAMPLE	// ToUpper server example in GenericTCPServer.c - SEPT/27TH
#define STACK_USE_TELNET_SERVER			// Telnet server - SEPT/27TH
...
//#define MY_DEFAULT_HOST_NAME			"mx79" //**original code
#define MY_DEFAULT_HOST_NAME			"mx18" //**sept/17th changes for my board: lab 1.1.2 [22]**
...
//#define MY_DEFAULT_MAC_BYTE6            (0x79)	//INitial code 
#define MY_DEFAULT_MAC_BYTE6            (0x18)	// **Sept/17th 


#define MY_DEFAULT_IP_ADDR_BYTE1        (192ul)
#define MY_DEFAULT_IP_ADDR_BYTE2        (168ul)
#define MY_DEFAULT_IP_ADDR_BYTE3        (1ul)
//#define MY_DEFAULT_IP_ADDR_BYTE4        (79ul)//initial code
#define MY_DEFAULT_IP_ADDR_BYTE4        (18ul)// ** sept/17th changes ?? 0x18ul maybe
...
//#define MY_DEFAULT_GATE_BYTE4           (79ul) //**initial code
#define MY_DEFAULT_GATE_BYTE4           (24ul) //**sept/17th changes 16 hexa to decimal
...
//#define MY_DEFAULT_PRIMARY_DNS_BYTE4		(79ul) //**initial code
#define MY_DEFAULT_PRIMARY_DNS_BYTE4		(24ul) //**sept/17th changes
...
//  IF I CREATE NEW SERVER#define TCP_PIC_RAM_SIZE					(12669 + 9*2 +  2+44+6+6) 
    #define TCP_PIC_RAM_SIZE					(12669 + 9*2 + (2+44+168+2) +(2+44+2+2)) //SEPT/27TH LEDTCPServer
    //#define TCP_PIC_RAM_SIZE					(12669 + 9*2 + (2+44+168+2) +(2+44+2+2)) //if i created new 
                                                               //44-TCP, 168-TFIFO (menu size), 2-RFIFO client sends 1 byte at a time 
//	#define TCP_PIC_RAM_SIZE					(16384ul)
	...
	#define TCP_SOCKET_TYPES
		...
		#define TCP_PURPOSE_LED_SERVER 12 //SEPT/27TH FOR LED SERVER
        #define TCP_PURPOSE_TCP_TO_UPPER_SERVER 13 //SEPT/27TH FOR TOUPPER used in TCPToUpperServer.c
	#define END_OF_TCP_SOCKET_TYPES
		...
		} TCPSocketInitializer[] =
		{
			...
			{TCP_PURPOSE_LED_SERVER, TCP_PIC_RAM, 168, 2}, //SEPT27TH ALREADY HAVE MEMORY ALLOCATED??
            //IF I CREATE NEW SERVER{TCP_PURPOSE_P3_3_SERVER, TCP_PIC_RAM, 6, 6}, //HERE TFIFO AND RFIFO ARE 6 coz led0#off - 6
            {TCP_PURPOSE_TCP_TO_UPPER_SERVER, TCP_PIC_RAM, 2, 2}, //SEPT27TH - TFIFO AND RFIFO is 1 Byte but added extra x2
		};
