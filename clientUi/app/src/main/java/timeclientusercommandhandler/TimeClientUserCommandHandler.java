 ...
 */
package timeclientusercommandhandler;

public class TimeClientUserCommandHandler implements Runnable {
    /*
    Based off the UML Class diagram we instatiate our server and the UI aka standar IO
    */
//    timeclientuserinterface.TimeClientUserInterface myUI;
    ...
    public TimeClientUserCommandHandler(frameworkuserinterface.FrameworkUserInterface myUI, frameworkclient.FrameworkClient myClient) {
//    public TimeClientUserCommandHandler(timeclientuserinterface.TimeClientUserInterface myUI, frameworkclient.FrameworkClient myClient) {
        this.myUI = myUI;
...
//                    myUI.update("Quiting program by User command");
            ...
            break;
//            case 16: //set portnumber
//                String portString = theCommand.split(" ")[1];
//                int portNumber = Integer.parseInt(portString);
//                myClient.setPort(portNumber);
//            case 17: //set portnumber
//                String ipString = theCommand.split(" ")[1];
//                myClient.setIPAddress(ipString);
            default: 
                break;
        }
    }
